...
public class BluetoothConnection {
    ...
    private static final String appName = "EpiWatch";
    ...
    private class ConnectThread extends Thread{
        ...
        public void run(){
            ...
            //This is a blocking call and will return
            //on a sucessful connection or an exception
            try {
                mmSocket.connect();
    ...
    //with the other devices AcceptThread

    public void startClient(BluetoothDevice device, UUID uuid){
        Log.d(TAG, "startClient: Started.");

        //initaite progress dialog
    ...
    private class ConnectedThread extends Thread{
        ...
        //Call this from the main activity to send data to the to the remote device
        ...
        public void write(byte[] bytes){
            ...
            try{
                ...
                Log.e(TAG, "write:Error writing to the  ." + e.getMessage());
            }

        }

        //Call this from the Bluetooth activity to shutdown connection
        public void cancel() {
            try {
                mmSocket.close();
            } catch (IOException e){ }
    ...
    private void connected(BluetoothSocket mmSocket, BluetoothDevice mmDevice){
        ...
        //Start the thread to manage the connection and pefor transmissions
